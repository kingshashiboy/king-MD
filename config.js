...
module.exports = {
  ...
  AUTO_TYPING: convertToBool(process.env.AUTO_TYPING || "true"),     // 💬 Typing animation
  ALWAYS_ONLINE: convertToBool(process.env.ALWAYS_ONLINE || "true"),      // 🌐 Keep bot always online
  AUTO_STATUS_VIEW: convertToBool(process.env.AUTO_STATUS_VIEW || "true"),   // 👁️‍🗨️ View WhatsApp statuses
  AUTO_STATUS_REACT: convertToBool(process.env.AUTO_STATUS_REACT || "true")  // 💞 React to statuses
};
